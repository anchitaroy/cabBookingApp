...
public class PaymentsFeedbackController {
	...
	@PutMapping(value = "/updateFeedback", produces = "application/json", consumes = "application/json")
	public Report updateReport(@RequestBody TripDetails tripDetails) {
		return service.updateReport(tripDetails);
	}
	
	@PutMapping(value = "/updateTripRating", produces = "application/json", consumes = "application/json")
